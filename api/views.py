    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            if not products.exists():
                return Response({'error': 'product was not found'}, status=status.HTTP_404_NOT_FOUND)
            ...
            return Response({'error': 'product_id was not given'}, status=status.HTTP_400_BAD_REQUEST)
